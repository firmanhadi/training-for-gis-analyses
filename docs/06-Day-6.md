...
\caption{Open Attribute Table}(\#fig:fig1424)
\end{figure}
...
\caption{Select Features by expression button}(\#fig:fig1425)
\end{figure}
...
\caption{Select by expression window}(\#fig:fig1426)
\end{figure}
...
\caption{Selected records}(\#fig:fig1427)
\end{figure}
...
\caption{Save Vector Layer As window}(\#fig:fig1429)
\end{figure}
...
\caption{Selecting new CRS}(\#fig:fig1428)
\end{figure}
...
\caption{Lao Admin Boundary Level 2}(\#fig:fig1419)
\end{figure}
...
\caption{Dissolve menu}(\#fig:fig1419a)
\end{figure}
...
\caption{NAME1 selected as Unique ID}(\#fig:fig1420)
\end{figure}
...
\caption{Dissolved region}(\#fig:fig1421)
\end{figure}
...
\caption{Extract layer extent}(\#fig:fig1422)
\end{figure}
...
\caption{Layer extent created}(\#fig:fig1423)
\end{figure}
...
\caption{Reclassifying the elevation data}(\#fig:fig1474)
\end{figure}
...
\caption{Reclassified elevation data}(\#fig:fig1475)
\end{figure}
...
\caption{Save raster layer as}(\#fig:fig1471)
\end{figure}
...
\caption{Calculating slope}(\#fig:fig1472)
\end{figure}
...
\caption{Calculating hillshade}(\#fig:fig1473)
\end{figure}
...
\caption{General principle of creating heatmaps}(\#fig:fig1400)
\end{figure}
...
\caption{General principle of creating heatmaps}(\#fig:fig1409)
\end{figure}
...
\caption{Distribution of the point influence for different kernel}(\#fig:fig1410)
\end{figure}
...
\caption{Heatmap result in greyscale}(\#fig:fig1476)
\end{figure}
...
\caption{Heatmap result  pseudocolor}(\#fig:fig1477)
\end{figure}
...
\caption{Heatmap result  pseudocolor}(\#fig:fig1478)
\end{figure}
...
\caption{Mask for heatmap}(\#fig:fig1479)
\end{figure}
...
\caption{Polygonized mask}(\#fig:fig1480)
\end{figure}
...
\caption{Cleaned hotspot polygon}(\#fig:fig1481)
\end{figure}
...
\caption{Creating Contour}(\#fig:fig1482)
\end{figure}
...
\caption{Contour heatmap}(\#fig:fig1483)
\end{figure}
...
\caption{Example of the "is within" point-to-point relationship}(\#fig:fig1401)
\end{figure}
...
\caption{Example of the "nearest to point-to-line" relationship}(\#fig:fig1402)
\end{figure}
...
\caption{Example of the "is contained in" point-to-polygon relationship}(\#fig:fig1403)
\end{figure}
...
\caption{Example of the "intersects" line-to-polygon relationship}(\#fig:fig1404)
\end{figure}
...
\caption{Example of the "completely within" polygon-to-polygon relationship}(\#fig:fig1405)
\end{figure}
...
\caption{Field Calculator}(\#fig:fig1433)
\end{figure}
...
\caption{Band 1 Metadata}(\#fig:fig1436)
\end{figure}
...
\caption{Reclassified raster}(\#fig:fig1437)
\end{figure}
...
\caption{Proximity analyses}(\#fig:fig1438)
\end{figure}
...
\caption{Field Calculator}(\#fig:fig1439)
\end{figure}
...
\caption{list of layers weighted by their importance for general suitability}(\#fig:fig1440)
\end{figure}
...
\caption{Suitability layer}(\#fig:fig1441)
\end{figure}
...
\caption{Suitability map}(\#fig:fig1442)
\end{figure}
...
\caption{Polygonize}(\#fig:fig1443)
\end{figure}
...
\caption{Masking raster}(\#fig:fig1444)
\end{figure}
...
\caption{Reclass maximum suitability}(\#fig:fig1445)
\end{figure}
...
\caption{Select by location}(\#fig:fig1446)
\end{figure}
...
\caption{Selected maximum suitability}(\#fig:fig1447)
\end{figure}
...
\caption{Exact buildings from selected maximum suitability}(\#fig:fig1448)
\end{figure}
...
\caption{Final result}(\#fig:fig1449)
\end{figure}
