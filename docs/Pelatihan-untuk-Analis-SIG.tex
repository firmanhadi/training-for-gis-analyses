...
Pergi ke GeoServerunduh halaman seperti yang ditunjukkan pada tangkapan layar berikut ( \url{http://geoserver.org/download/} ) dan pilihlah tipe instalasi yang tersedia. Anda akan menemukan beberapa paket berbeda untuk GeoServer. Kita akan menggunakan versi Arsip Web:
