...
<img src="images/08/ms1.png" alt="Open Attribute Table" width="50%" />
<p class="caption">(\#fig:fig181)Open Attribute Table</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/08/ms2.png" alt="Open Attribute Table" width="50%" />
<p class="caption">(\#fig:fig182)Open Attribute Table</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/08/ms3.png" alt="Open Attribute Table" width="50%" />
<p class="caption">(\#fig:fig183)Open Attribute Table</p>
</div>
